...
namespace Registro_Visitas_Renso_Soriano.Controllers
{
    public class EventsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string search = null)
        {
            ...
            else
            {
                return View(await _context.Events
                    .Where(a => a.EventName.Contains(search)).
                    ToListAsync());
            }
        }
        ...
        public async Task<IActionResult> Create([Bind("EventId,EventName")] Events events)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EventId,EventName")] Events events)
        {
